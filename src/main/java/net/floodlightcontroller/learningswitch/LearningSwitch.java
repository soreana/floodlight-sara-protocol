...
public class LearningSwitch
	...
	///////////////////////////////////////////////////////////////////////////
	public void setHosts(IOFSwitch sw) {
		mySara.addHosts(sw);
	}
	///////////////////////////////////////////////////////////////////////////

	///////////////////////////////////////////////////////////////////////////
	private Long setNextSwitchId(IOFSwitch sw) {
		if (!this.extractionStarted) {
			this.extractionStarted = true;
			mySara.nextSwitch = sw.getId().getLong();
			mySara.BFSQueue.add(sw.getId().getLong());
		}
		return mySara.nextSwitch;
	}
	///////////////////////////////////////////////////////////////////////////
	...
	private void doFlood(IOFSwitch sw, OFPacketIn pi, FloodlightContext cntx) {
		...
		///////////////////////////////////////////////////////////////////////////
		long nextSwitchId = setNextSwitchId(sw);
		///////////////////////////////////////////////////////////////////////////
		...
		if ( ! mySara.haveEntryFor(currentSwitchId) && SaraProtocolUtils.ICareAbout(cntx)) {
			...
			switch (myProtocolState) {
				case BROADCAST:
					///////////////////////////////////////////////////////////////////////////
					if(currentSwitchId == nextSwitchId) {
						...
						myProtocolState.stayInGetRespondFor(sw.getPorts().size() - 1, this);
						break;
					}
					else {
						OFPort nextPortInPath = mySara.findNextPort(currentSwitchId, nextSwitchId);
						for (OFPortDesc p : sw.getPorts())
							if (p.equals(nextPortInPath))
								actions.add(sw.getOFFactory().actions().output(nextPortInPath, Integer.MAX_VALUE));
					}
				case GET_RESPOND:
					if(currentSwitchId == nextSwitchId) {
						mySara.learnLinkForCurrentSwitch(sw.getId().getLong(), inPort, mySara.delay());
...
//        }
		...
		OFPort outPort = getFromPortMap(sw, destMac, VlanVid.ofVlan(16));
