...
public class LearningSwitch
    ...
    private SaraProtocol mySara = new SaraProtocol();
        ...
        ////****
        static boolean ICareAbout_type(FloodlightContext cntx,boolean type/*0 for ARP, 1 for IPv4*/) {
            ...
            switch (myProtocolState) {
                ...
                case BROADCAST:
                    ...
                    for (OFPortDesc p : sw.getPorts()) {
                        ...
                        ////****
                        //add this switch to marked switch
                        // todo mark ports
                        startBroadcast = System.currentTimeMillis() % 1000 - startBroadcast;
                        ////****
                ...
                case GET_RESPOND:
                    ////**** 
                    //IF arp drop else next.state
                    //if (ICareAbout_type(cntx,1)) EDAME else DROP
                    value = (System.currentTimeMillis() % 1000 )- startBroadcast;
                    
                    mySara.learnLinkForCurrentSwitch(sw.getId().getLong(),inPort,value);
                    ////****
